...
WPILib **2025** Java project. Drivetrain code was generated by the **Tuner X Swerve Project Generator** and then hand-edited for two MiniMiniBot specifics:
...
```bash
# Open in WPILib VSCode
code .

# From the WPILib VSCode "WPILib" command palette:
#   - "Build robot code"
#   - "Deploy robot code"
```
